...
const RadarChart = (): JSX.Element => {
  ...
  const calcMedia = () => {
    return (
      (parseFloat(radarChart.RadarChartCard[0].corpo) +
        parseFloat(radarChart.RadarChartCard[0].mente) +
        parseFloat(radarChart.RadarChartCard[0].emocoes)) /
      3
    )
      .toFixed(1)
      .replace('.', ',');
              ...
              <View style={styles.profileContent}>
                ...
                <View>
                  <Text style={styles.nameProfile}>
                    {radarChart.HeaderRadarCard[0].nome}
                  </Text>
                  <Text style={styles.subProfile}>Meu Corpo 36Oº</Text>
                  <Text style={styles.lastAnalysis}>
                    Ultima análise às 5:37 PM, hoje
                  </Text>
                </View>
              </View>

              <LinearGradient colors={['#F1C4BF', '#F1C4BF', '#C7A8A5']}>
                <View style={styles.score}>
                  ...
                  <View>
                    <Text style={styles.averageNumber}>
                      {radarChart.MediaDaPopulacao[0].mediafinal
                        .toFixed(1)
                        .replace('.', ',')}
                    </Text>
                    ...
                    dataSets: [
                      {
                        values: [
                          {
                            value: parseFloat(
                              radarChart.RadarChartCard[0].corpo
                            ),
                          },
                          {
                            value: parseFloat(
                              radarChart.RadarChartCard[0].mente
                            ),
                          },
                          {
                            value: parseFloat(
                              radarChart.RadarChartCard[0].emocoes
                            ),
                          },
                        ],
            ...
            <View style={styles.mainCardView}>
              <View style={styles.historyHeader}>
                ...
                <Text style={styles.subTitle}>
                  Sua evolução na linha do tempo
                </Text>
                <Text style={styles.dateHistory}>
                  De{' '}
                  {convertDate(
                    radarChart.LinesChartCard[
                      radarChart.LinesChartCard.length - 1
                    ].data
                  )}{' '}
                  à {convertDate(radarChart.LinesChartCard[0].data)}
                </Text>
              </View>
                    ...
                    dataSets: [
                      {
                        ...
                        values: [
                          {
                            y: parseFloat(
                              radarChart.LinesChartCard[0].resultado
                            ),
                          },
                          {
                            y: parseFloat(
                              radarChart.LinesChartCard[1].resultado
                            ),
                          },
                          {
                            y: parseFloat(
                              radarChart.LinesChartCard[2].resultado
                            ),
                          },
                        ],
                      },
              ...
              <View style={styles.buttonContent}>
                <TouchableOpacity style={styles.buttonCard} onPress={() => {}}>
                  <Text style={styles.textButtonCard}>
