...
const Recomendation = (): JSX.Element => {
    ...
    const renderItem = (item: any) => {
        ...
        return (
            ...
            <TouchableHighlight
                onPress={() => { handleDetails(item.item.tratamento) }}
            >
                    ...
                    <ScrollView>
                        {
                            ...
                            <>
                                <Text style={styles.titleRecomendation}>Medicina Tradicional</Text>
                                <Text style={styles.subTitleRecomendation}>A sua qualidade de vida é o seu auto cuidado</Text>
                                <FlatList
                                    data={recomendation}
                                    horizontal={true}
